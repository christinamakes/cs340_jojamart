...
export const UpdateSalesDetailsPage = () => {
    ...
    return (
        ...
        <div>
            ...
            <select id='uSaleDetProd' name='productId' onChange={e => setProductId(e.target.value)}>
                <option value='1'>1</option>
                <option value='2'>2</option>
                <option value='3'>3</option>
            </select>
            <label for='uSaleDetOrd'>Order Number: </label>
            <select id='uSaleDetOrd' name='orderNumber' onChange={e => setOrderNumber(e.target.value)}>
                <option value='1'>1</option>
                <option value='2'>2</option>
                <option value='3'>3</option>
            </select>
            ...
            <select id='uSaleDetOrdType' name='orderNumber' onChange={e => setOrderType(e.target.value)}>
