...
export const UpdateSalesDetailsPage = ({salesDetailToEdit}) => {
    ...
    const [quantity, setQuantity] = useState(salesDetailToEdit);
    const [order_type, setOrderType] = useState(salesDetailToEdit);
    // For Sales
    const [member_id, setMember] = useState(salesDetailToEdit);
    const [employee_id, setEmployee] = useState(salesDetailToEdit);
    const [purchase_date, setDate] = useState(salesDetailToEdit);
    const [invoice_total, setTotal] = useState(salesDetailToEdit);
